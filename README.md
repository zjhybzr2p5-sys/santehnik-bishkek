...
<div class="card">🔧 Устранение протечек</div>
<div class="card">🚿 Установка и замена смесителей</div>
<div class="card">🚽 Установка унитазов</div>
<div class="card">🛁 Монтаж ванн и раковин</div>
<div class="card">🚰 Прочистка канализации</div>
<div class="card">🔥 Замена труб</div>
</div>
</section>
...
<div class="grid grid-3">
<div class="card highlight">✅ Более 5 лет опыта</div>
<div class="card highlight">✅ Работаем без выходных</div>
<div class="card highlight">✅ Гарантия на все работы</div>
</div>
</section>
